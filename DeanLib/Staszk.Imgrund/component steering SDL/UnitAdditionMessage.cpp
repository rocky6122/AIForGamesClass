...
{
	//This is where the final WanderAndChase random unit info will go
	//std::cout << "PROVE THIS WORKS" << std::endl;
	...
	gpGame->getUnitManager()->setInitialEnemyUnitState(pRandomUnit);
}