...
enum TransitionType
{
	...
	/*ENEMY AI TRANSITION LIST*/
	TO_WANDER_TRANSITION = 0,
	TO_DAMAGE_ENEMY_TRANSITION = 1,
	TO_DIE_TRANSITION = 2,
	TO_SEEK_PICKUP_TRANSITION = 3,
	/*PLAYER TRANSITION LIST*/
	TO_MOVE_TRANSITION = 4,
	TO_ARRIVE_TRANSITION = 5,
	TO_AI_TRANSITION = 6,
	END_GAME_TRANSITION = 7
};
