...
Unit::Unit(const Sprite& sprite, const int unitType, const float maxHealth, const float damageVal, const float damageRadius)
	:mSprite(sprite)
...
void Unit::modifyHealth(int healthValue)
{
	mCurrentHealth += healthValue;
...
StateMachine * Unit::InitializeStateMachine()
{
	mpStateMachine = new StateMachine;

	return mpStateMachine;
}
